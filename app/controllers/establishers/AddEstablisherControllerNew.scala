...
class AddEstablisherControllerNew @Inject()(
  ...
  def onPageLoad: Action[AnyContent] =
    (authenticate andThen getData andThen requireData()).async {
      implicit request =>
        ...
        val establishersComplete = allEstablishers.filter(_.isCompleted)
        val establishersIncomplete = allEstablishers.filterNot(_.isCompleted)
        ...
        renderer.render(
          ...
          ctx = Json.obj(
            "form" -> formProvider(allEstablishers),
            "completeTable" -> completeTable,
            "incompleteTable" -> incompleteTable,
            "radios" -> Radios.yesNo(formProvider(allEstablishers)("value")),
