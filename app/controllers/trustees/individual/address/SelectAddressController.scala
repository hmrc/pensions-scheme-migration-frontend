...
import identifiers.trustees.individual.address.{EnterPostCodeId, AddressListId, AddressId}
...
class SelectAddressController @Inject()(val appConfig: AppConfig,
  ...
  override def form: Form[Int] = formProvider("trusteeSelectAddress.required")
