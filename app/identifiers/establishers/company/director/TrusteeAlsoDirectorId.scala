...
case class TrusteeAlsoDirectorId(establisherIndex: Int) extends TypedIdentifier[Int] {
  override def path: JsPath = EstablishersId(establisherIndex)
    .path \ TrusteeAlsoDirectorId.toString
}

object TrusteeAlsoDirectorId {
  override def toString: String = "trusteeAlsoDirector"
}
