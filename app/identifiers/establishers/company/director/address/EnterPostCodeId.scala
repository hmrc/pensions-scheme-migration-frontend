...
case class EnterPostCodeId(establisherIndex: Int, directorIndex: Int) extends TypedIdentifier[Seq[TolerantAddress]] {
  override def path: JsPath =
    EstablishersId(establisherIndex).path \ "director" \ directorIndex \ EnterPostCodeId.toString
}
