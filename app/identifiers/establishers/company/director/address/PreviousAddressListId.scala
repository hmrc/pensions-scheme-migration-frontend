...
case class PreviousAddressListId(establisherIndex: Int, directorIndex: Int) extends TypedIdentifier[TolerantAddress] {
  override def path: JsPath =
    EstablishersId(establisherIndex).path \ "director" \ directorIndex \ PreviousAddressListId.toString
}
