  ...
  def contactDetailsRows(
    ...
    val rowsWithoutDynamicIndices = Seq(
      Some(answerOrAddRow(
        ...
        message = Message("messages__enterEmail_cya_label", trusteePartnershipName).resolve,
      ...
      Some(answerOrAddRow(
        ...
        message = Message("messages__enterPhone_cya_label", trusteePartnershipName).resolve,
