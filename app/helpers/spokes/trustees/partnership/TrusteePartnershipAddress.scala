...
import controllers.trustees.partnership.address.routes.{CheckYourAnswersController, WhatYouWillNeedController}
...
case class TrusteePartnershipAddress(
  ...
  override def completeFlag(answers: UserAnswers): Option[Boolean] =
    answers.isTrusteePartnershipAddressCompleted(index, answers)
}
