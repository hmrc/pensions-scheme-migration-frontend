...
import controllers.trustees.partnership.details.routes.{CheckYourAnswersController, WhatYouWillNeedController}
...
case class TrusteePartnershipDetails(
  ...
  override def completeFlag(answers: UserAnswers): Option[Boolean] =
    answers.isTrusteePartnershipDetailsCompleted(index)
}
