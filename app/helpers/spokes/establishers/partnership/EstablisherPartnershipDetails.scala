...
//
//import controllers.establishers.partnership.details.routes.{CheckYourAnswersController, WhatYouWillNeedController}
...
//    answers.isEstablisherPartnershipDetailsCompleted(index)
//}
//
