...
class BenefitsTypeControllerSpec extends ControllerSpecBase {
  ...
  private val httpPathGET: String = controllers.benefitsAndInsurance.routes.BenefitsTypeController.onPageLoad().url
  ...
  "BenefitsType Controller" must {
    ...
    "Return OK and the correct view for a GET" in {
      ...
      verify(mockRenderer, times(1))
        .render(Matchers.eq("benefitsAndInsurance/benefitsType.njk"), jsonCaptor.capture())(any())
