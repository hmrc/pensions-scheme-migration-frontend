...
import identifiers.trustees.company.details.HaveUTRId
...
class HaveUTRControllerSpec extends ControllerSpecBase with NunjucksSupport with JsonMatchers with TryValues with BeforeAndAfterEach {
  ...
  private val form: Form[Boolean] = formProvider(Message("messages__genericHasUtr__error__required", company.companyName))
  ...
  private val commonJson: JsObject =
    Json.obj(
      ...
      "pageHeading"     -> messages("messages__hasUTR", company.companyName),
