...
class TrusteeNoNINOReasonControllerSpec
  ...
  private val pageTitle = "Why does the individual not have a National Insurance number?"
  ...
  private val httpPathPOST = controllers.trustees.individual.details.routes.TrusteeNoNINOReasonController.onSubmit(index, mode).url
