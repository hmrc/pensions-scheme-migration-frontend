...
class ConfirmPreviousAddressControllerSpec extends ControllerSpecBase with JsonMatchers with Enumerable.Implicits {
  ...
  private val ua: UserAnswers =
    Data.ua.setOrException(TrusteeNameId(index), Data.individualName)

  private val userAnswers: Option[UserAnswers] = Some(ua)
  private val httpPathGET: String = controllers.trustees.individual.address.routes.ConfirmPreviousAddressController.onPageLoad(index, mode).url
  private val httpPathPOST: String = controllers.trustees.individual.address.routes.ConfirmPreviousAddressController.onSubmit(index, mode).url
