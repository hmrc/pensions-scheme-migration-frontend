...
class SelectAddressControllerSpec extends ControllerSpecBase with NunjucksSupport with JsonMatchers with Enumerable.Implicits {
  ...
  private val httpPathGET: String = controllers.trustees.partnership.address.routes.SelectAddressController.onPageLoad(0).url
  private val httpPathPOST: String = controllers.trustees.partnership.address.routes.SelectAddressController.onSubmit(0).url
