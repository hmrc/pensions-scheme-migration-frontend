...
class CurrentMembersControllerSpec extends ControllerSpecBase with NunjucksSupport with JsonMatchers {
  ...
  private val form = new MembersFormProvider()(Message("currentMembers.error.required", schemeName))
  ...
  private val jsonToPassToTemplate: Form[Members] => JsObject = form => Json.obj(
    "form" -> form,
