...
class EnterPostcodeControllerSpec extends ControllerSpecBase with NunjucksSupport with JsonMatchers with Enumerable.Implicits {
  ...
  private val httpPathGET: String = EstablishersIndividualRoutes.enterPostcodeRoute(0, NormalMode).url
  private val httpPathPOST: String = EstablishersIndividualRoutes.enterPostcodePOSTRoute(0, NormalMode).url
