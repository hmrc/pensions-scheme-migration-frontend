...
class SelectPreviousAddressControllerSpec extends ControllerSpecBase with JsonMatchers with Enumerable.Implicits {
  ...
  private val httpPathGET: String = controllers.establishers.individual.address.routes.SelectPreviousAddressController.onPageLoad(index,mode).url
  private val httpPathPOST: String = controllers.establishers.individual.address.routes.SelectPreviousAddressController.onSubmit( index,mode).url
