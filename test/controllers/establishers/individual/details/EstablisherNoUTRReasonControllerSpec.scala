...
class EstablisherNoUTRReasonControllerSpec
  ...
  private val commonJson: JsObject =
    Json.obj(
      "pageTitle"     -> "Why does the individual not have a UTR?",
  ...
  private def controller(
                        ...
                        ): EstablisherNoUTRReasonController =
    new EstablisherNoUTRReasonController(
  ...
  "EstablisherNoUTRReasonController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val ua =
        userAnswers
          .set(EstablisherNoUTRReasonId(0), formData).success.value
