...
import identifiers.establishers.partnership.contact.EnterPhoneId
...
class EnterPhoneControllerSpec extends ControllerSpecBase
  ...
  private val partnership: PartnershipDetails = PartnershipDetails("test", false)
  ...
  "EnterPhoneController" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      contentAsString(result) must include(messages("messages__enterPhone_pageHeading", partnership.partnershipName))
