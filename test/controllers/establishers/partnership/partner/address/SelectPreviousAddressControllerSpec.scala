...
class SelectPreviousAddressControllerSpec extends ControllerSpecBase with JsonMatchers with Enumerable.Implicits {
  ...
  private val httpPathGET: String = controllers.establishers.partnership.partner.address.routes.SelectPreviousAddressController.onPageLoad(index, index, mode).url
  private val httpPathPOST: String = controllers.establishers.partnership.partner.address.routes.SelectPreviousAddressController.onSubmit(index, index, mode).url
  ...
  "SelectPreviousAddress Controller" must {
    ...
    "Return OK and the correct view for a GET" in {
      val ua: UserAnswers = Data.ua
        .setOrException(EnterPreviousPostCodeId(index, index), seqAddresses)
      ...
      val expectedView = view(
        ...
        enterManuallyUrl = controllers.establishers.partnership.address.routes.ConfirmPreviousAddressController.onPageLoad(index,mode).url,
