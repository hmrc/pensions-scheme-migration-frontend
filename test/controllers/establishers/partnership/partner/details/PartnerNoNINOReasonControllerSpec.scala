...
class PartnerNoNINOReasonControllerSpec
  ...
  private val submitCall = controllers.establishers.partnership.partner.details.routes
    .PartnerNoNINOReasonController.onSubmit(establisherIndex, partnerIndex, mode)
