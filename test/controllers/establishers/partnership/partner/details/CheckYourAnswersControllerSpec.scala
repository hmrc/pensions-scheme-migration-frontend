...
class CheckYourAnswersControllerSpec
  ...
  private val cyaHelper =
    new EstablisherPartnerDetailsCYAHelper
  ...
  private val uaNinoUtr: UserAnswers =
    userAnswers
      ...
      .set(PartnerNINOId(0,0), ReferenceValue("AB123456C")).success.value
      .set(PartnerHasUTRId(0,0), true).success.value
      .set(PartnerEnterUTRId(0,0), ReferenceValue("1234567890")).success.value
