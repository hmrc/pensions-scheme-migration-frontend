...
class PartnerHasUTRControllerSpec
  ...
  "PartnerHasUTRController" must {
    "return OK and the correct view for a GET" in {
      ...
      val view = app.injector.instanceOf[HasReferenceValueWithHintView].apply(
        form,
        "Test scheme name",
        "Does the partner have a Unique Taxpayer Reference (UTR)?",
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) must include("Does the partner have a Unique Taxpayer Reference (UTR)?")
