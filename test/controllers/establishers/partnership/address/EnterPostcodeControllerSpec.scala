...
class EnterPostcodeControllerSpec extends ControllerSpecBase with NunjucksSupport with JsonMatchers with Enumerable.Implicits {
  ...
  private val httpPathGET: String = controllers.establishers.partnership.address.routes.EnterPostcodeController.onPageLoad(0).url
  private val httpPathPOST: String = controllers.establishers.partnership.address.routes.EnterPostcodeController.onSubmit(0).url
