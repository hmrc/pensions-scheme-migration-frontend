...
class EnterPreviousPostcodeControllerSpec extends ControllerSpecBase with JsonMatchers with Enumerable.Implicits {
  ...
  private val httpPathGET: String = controllers.establishers.company.director.address.routes.EnterPreviousPostcodeController.onPageLoad(index, directorIndex, mode).url
  private val httpPathPOST: String = controllers.establishers.company.director.address.routes.EnterPreviousPostcodeController.onSubmit(index, directorIndex, mode).url
  ...
  "EnterPreviousPostcode Controller" must {
    ...
    "Return OK and the correct view for a GET" in {
      ...
      val expectedView = view(
        ...
        routes.EnterPreviousPostcodeController.onSubmit(index, directorIndex, mode),
        routes.ConfirmPreviousAddressController.onPageLoad(index, directorIndex, mode).url,
