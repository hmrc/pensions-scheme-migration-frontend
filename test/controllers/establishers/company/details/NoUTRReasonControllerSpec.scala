...
class NoUTRReasonControllerSpec
  ...
  private val httpPathGET = controllers.establishers.company.details.routes.NoUTRReasonController.onPageLoad(index, mode).url
  private val submitCall = controllers.establishers.company.details.routes.NoUTRReasonController.onSubmit(index, mode)
