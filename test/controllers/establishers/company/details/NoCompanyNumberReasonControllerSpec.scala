...
class NoCompanyNumberReasonControllerSpec
  ...
  private val httpPathGET = controllers.establishers.company.details.routes.NoCompanyNumberReasonController.onPageLoad(index, mode).url
  private val httpPathPOST = controllers.establishers.company.details.routes.NoCompanyNumberReasonController.onSubmit(index, mode).url
