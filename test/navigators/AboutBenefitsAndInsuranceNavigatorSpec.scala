...
//import identifiers.benefitsAndInsurance.{BenefitsInsuranceNameId, HowProvideBenefitsId, IsInvestmentRegulatedId, IsOccupationalId}
...
//          row(IsInvestmentRegulatedId)(false, occupationalPension),
//          row(IsOccupationalId)(false, typesofBenefits),
//          row(HowProvideBenefitsId)(Defined, benefitsSecured),
//          row(HowProvideBenefitsId)(MoneyPurchase, moneyPurchaseBenefits()),
...
//        Table(
//          ("Id", "UserAnswers", "Next Page"),
//          row(IsInvestmentRegulatedId)(false, checkYouAnswers()),
//          row(IsOccupationalId)(false, checkYouAnswers()),
//          row(HowProvideBenefitsId)(Defined, checkYouAnswers()),
//          row(HowProvideBenefitsId)(MoneyPurchase, moneyPurchaseBenefits(CheckMode)),
